...
public class PlayerLogon extends Thread {
    ...
    private static final Logger log = Logger.getLogger(PlayerLogon.class.getName());
    ...
    public PlayerCharacter loadCharacter(String name) throws IOException, SocketException {
     ...
     */
    private PlayerCharacter doCreateNewCharacter(String playerName) throws IOException, SocketException {
        String password;
        int gender;
        Race race;
        Alignment alignment;
    ...
    public String getPlayerName() throws IOException, SocketException {
        ...
        do {
            ...
            //TODO: check both active and inactive players by querying the player store.
            playerActive = false;
