...
public class Body implements Serializable {
	...
	// This class defines a body, equipment slots, and the racial abilities it
	// has. Numerous
	// different body parts can be created and can be all added. This means that
	// a mobile
	...
	public static BodyPart TENTACLE = new BodyPart("tentacle");// illithid
																// tentacle.
	...
	public static BodyPart SMALL_BODY = new BodyPart("body");// body for stuff
																// like rabbits.
	public static BodyPart MEDIUM_BODY = new BodyPart("body");// normal body.
	public static BodyPart LARGE_BODY = new BodyPart("body");// body for stuff
																// like ogres.
	public static BodyPart HUGE_BODY = new BodyPart("body");// body for stuff
															// like young
															// dragons.
	public static BodyPart COLOSSAL_BODY = new BodyPart("body");// body for stuf
																// like dragons.
	public static BodyPart FACE = new BodyPart("face");
	public static BodyPart SHOULDER = new BodyPart("shoulder");

	// Other variables.
	private Vector<BodyPart> bodyParts;
	...
	// getPart method.
	// This method will get the first empty occurance of the type of body part
	// specified
	// by the index.
	...
	public BodyPart[] getEligibleBodyParts(Item item) {
		...
		for (int c = 0; c < bodyParts.size(); c++) {
			...
			if (part.equalsIgnoreItem(otherPart) && (!(otherPart.hasItem())))
	...
	public Vector<BodyPart> getBodyParts() {
		return bodyParts;
	}
	...
	// These methods create stock bodies. There are bodies for all of the races,
	// as well as
	// generic/specific NPC body creation methods. These methods should be
	// called by the race
