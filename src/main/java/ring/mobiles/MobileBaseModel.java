...
public class MobileBaseModel {
    ...
    public enum Type {
        ...
        public boolean isGod() {
            return (this == LESSER_GOD || this == GOD || this == FORGER);
        }
    ...
    public void setMobileClass(MobileClass mobClass) {
    ...
    public List<Race> getRaceAggressiveList() {
        return raceAggressiveList;
    }

    public void setRaceAggressiveList(List<Race> list) {
        raceAggressiveList = list;
    }
    ...
    public List<Alignment> getAlignmentAggressiveList() {
        return alignmentAggressiveList;
    }

    public void setAlignmentAggressiveList(List<Alignment> list) {
        alignmentAggressiveList = list;
    }
    ...
    public void setLeftHanded(boolean val) {
        isLeftHanded = val;
    }
    ...
    public void setProne(boolean val) {
        isProne = val;
    }
    ...
    public void setLyingDown(boolean val) {
        isLyingDown = val;
    }
